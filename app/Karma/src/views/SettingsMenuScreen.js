...
class SettingsMenuScreen extends Component {
    ...
    render() {
        ...
        return (
            ...
            <SettingsButton title = "Report A Problem" icon={icons.report} onPress={() => navigate("Activities")}></SettingsButton>
            <SettingsButton title = "About KARMA" icon={icons.logo} onPress={() => navigate("Activities")}></SettingsButton>
            <SettingsButton title = "Community Guidelines" icon={icons.guidelines} onPress={() => navigate("Activities")}></SettingsButton>
            <SettingsButton title = "Privacy Policy" icon={icons.privacy} onPress={() => navigate("Privacy")}></SettingsButton>
            <SettingsButton title = "Terms of Use" icon={icons.terms} onPress={() => navigate("Terms")}></SettingsButton>
            <SettingsButton title = "Emails Settings" icon={icons.email} onPress={() => navigate("Activities")}></SettingsButton>
