...
router.get('/causes', authService.requireAuthentication, async (req, res) => {
    try {
        log.info("%s: Getting all causes by UserId", req.query.userId ? `User id '${req.query.userId}'` : req.query.userId);
        ...
        log.error("%s: Getting all causes by UserId failed", req.query.userId ? `User id '${req.query.userId}'` : req.query.userId);
